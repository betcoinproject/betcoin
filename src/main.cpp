...
uint256 hashGenesisBlock("0x6a3df053c27c223d156e16c3cf5d54599b6ab1a91976108ab255d584a8d33143");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 262080 ); //Betcoin Halves every 6 months

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // BetCoin: 0.35 days
static const int64 nTargetSpacing = 30; // BetCoin: 30 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal betcoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1388928255;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085724204;

        if (fTestNet)
        {
            block.nTime    = 1388926367;
            block.nNonce   = 387450465;
        }
